...
public class Identification implements Serializable {
    ...
    /**
     *
     * Initialize a newly created Identification object with generation a new
     * key to identify.
     *
     */
    ...
    public Identification(String value) {
        ...
        if (Base62.isValid(value)) {
            ...
            throw new RuntimeException("Cannot instance class because the value is not valid.");
        }
    }
    ...
    /**
     *
     * Compares this Identification with other Identification object. The result
     * is true if and only if the argument is not null and is a Identifier
     * object that represents the same id value that this Identifier.
     *
     * @param id Identification object to compare.
     * @return true if the given object represents a Identifier equivalent to
     ...
     *
     * @return a string with value to Identification object.
     *
     */
